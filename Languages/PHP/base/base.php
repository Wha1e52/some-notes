...
session_regenerate_id(); # сгенерировать новый id сессии (рекомендуется выполнять после log in пользователя на всякий случай)
...
/*
composer install --dev // установить зависимости
composer require some-package // установить пакет
...
composer dump-autoload // обновить автозагрузку после изменений в composer.json

require 'vendor/autoload.php'; // подключить автозагрузку
*/
